...
import com.hpFrame.http.okhttp.callback.BitmapCallback;
import com.hpFrame.http.okhttp.callback.FileCallBack;
import com.hpFrame.http.okhttp.callback.StringCallback;
...
//                .params(params)//
    ...
    public void getWeatherInfo(View view){
    	...
    	String url = "http://mobile.weather.com.cn/data/zsM/101010100.html?_=1393645156001%22";
    	OkHttpUtils.get().url(url).build().execute(new StringCallback(){
			...
			public void onResponse(String response) {
				...
				infos = new Gson().fromJson(response, WeatherInfos.class);
				if(infos != null && infos.zs != null){
					String weatherinfos = "";
					for (WeatherInfo info : infos.zs) {
						weatherinfos += info.toString();
					}
					mTv.setText(weatherinfos);
				}
			}
